...
class ModalPresenter : Subscriber, Trackable {
    ...
    private func presentSettings() {
        ...
        let sections = ["Wallet", "Manage", "AmoleWallet", "Advanced"]
        var rows = [
            ...
            "Advanced": [
                Setting(title: "Advanced", callback: { [weak self] in
                    ...
                    let advancedSettings = [
                        "Network": [
                            Setting(title: "Amolecoin Nodes", callback: {
...
//                            })
       ...
       //     rows["AmoleWallet"]?.insert(Setting(title: S.Settings.earlyAccess, callback: {
       //         settingsNav.dismiss(animated: true, completion: {
       ...
       // }
        ...
        rows["AmoleWallet"]?.append( Setting(title: S.Settings.review, callback: {
