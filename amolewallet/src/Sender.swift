...
class Sender {
    ...
    private func postProtocolPaymentIfNeeded() {
        ...
        request.setValue("application/amolecoin-payment", forHTTPHeaderField: "Content-Type")
        request.addValue("application/amolecoin-paymentack", forHTTPHeaderField: "Accept")
        ...
        URLSession.shared.dataTask(with: request as URLRequest) { data, response, error in
            ...
            if response.mimeType == "application/amolecoincoin-paymentack" && data.count <= 50000 {
